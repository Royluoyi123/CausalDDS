...
if __name__ == "__main__":
    ...
    for i in range(1,6):
        ...
        df = pd.read_csv(f'DDS/ddsdata/DrugCombDB640/raw/classification10/SIMPD/train_'+str(i)+'.csv', sep=",")
        processed_data, dataset = build_dataset(df, "drug_a", "drug_b","cell_line","synergy", smiles_dict)
        torch.save(processed_data, "DDS/ddsdata/DrugCombDB640/processed/classification10/SIMPD/train_"+str(i)+".pt")
        ...
        df = pd.read_csv(f'DDS/ddsdata/DrugCombDB640/raw/classification10/SIMPD/test_'+str(i)+'.csv', sep=",")
        processed_data, dataset = build_dataset(df, "drug_a", "drug_b","cell_line","synergy", smiles_dict)
        torch.save(processed_data, "DDS/ddsdata/DrugCombDB640/processed/classification10/SIMPD/test_"+str(i)+".pt")
